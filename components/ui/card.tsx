...
const cardVariants = cva("bg-card text-card-foreground flex flex-col gap-3 rounded-3xl border py-3 shadow-sm", {
  variants: {
    variant: {
      default: "",
...
function Card({ className, variant = "default", ...props }: React.ComponentProps<"div"> & { variant?: "default" | "flat" | "flat_nopadding" }) {
  return (
    <div
      data-slot="card"
