...
function Tooltip({
  ...
  return (
    <TooltipProvider>
      <TooltipPrimitive.Root data-variant={variant} data-slot="tooltip" {...props} />
    </TooltipProvider>
  )
}
    ...
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          ...
          variant === "warning" ? "bg-[#fae9a3] border-[#b9950178] font-medium text-[#503e30] text-center" : " bg-black !text-white",
          className
        )}
        {...props}
      >
        ...
        <TooltipPrimitive.Arrow
          className={cn(
            "z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] fill-black ",
            variant === "warning" && "bg-[#fae9a3] fill-[#fae9a3]"
          )}
        />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
